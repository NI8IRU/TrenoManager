...
<body>
	...
	<div class="w3-top">
		<div class="w3-bar w3-black w3-card">
			...
			<a href="addUtente"
				class="w3-bar-item w3-button w3-padding-large w3-hide-small">REGISTRAZIONE</a>
			<a href="#contact"
			...
			<div class="w3-container w3-content w3-padding-64"
				...
				<div class="w3-row-padding w3-padding-32" style="margin: 0 -16px">
					<div class="w3-third w3-margin-bottom">
						<img src="resources\img\1.jpg" alt="New York"
						...
						<div class="w3-container w3-white">
							...
							<p>Una potente ed aerodinamica locomotiva per le alte velocità.</p>
						<!--  
					...
					<div class="w3-third w3-margin-bottom">
						<img src="resources\img\3.jpg" alt="New York"
							style="width: 100%" class="w3-hover-opacity">
						<div class="w3-container w3-white">
							<p>
								<b>CarGo</b>
							...
							<p>Questo bestione da 35000 cavalli è il più potente della categoria, per i carichi più pesanti.</p>
						<!--  
							<button class="w3-button w3-black w3-margin-bottom"
								onclick="document.getElementById('ticketModal').style.display='block'">Buy
								Tickets</button>
	...
	<footer
		...
		<i class="fa fa-youtube w3-hover-opacity"></i></a> <a
			href="https://www.linkedin.com/in/alfonso-d-angiolella-270a8a235/" target="_blank"><i
			class="fa fa-linkedin w3-hover-opacity"> </i></a> <a
			href="https://www.linkedin.com/in/roberto-tursi/" target="_blank"><i
			class="fa fa-linkedin w3-hover-opacity"> </i></a> <a
			href="https://www.linkedin.com/in/francesco-tornamb%C3%A8-8a5055278/" target="_blank"><i
			class="fa fa-linkedin w3-hover-opacity"> </i></a> <a
			href="https://www.cicciottocartofer.it/" target="_blank">
			<p class="w3-medium">Powered by Cicciotto Cartofer</p>
		</a> <a href="https://www.youtube.com/@CodeWithNaval" target="_blank">
			<p class="w3-medium">Ringrazio colui senza il quale non avremmo potuto
				fare nulla</p>
		</a>
	</footer>
